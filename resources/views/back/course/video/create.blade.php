            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        @if ($errors->any())
                            <div class="alert alert-danger">
                                <span><b>Create video failed</b></span>
                                <ul>
                        ...
                        <form action="{{ route('lms.videos.store') }}" method="post" id="create">
                            @csrf
                            ...
                            <div class="mb-3">
                                <label for="price" class="form-label">Course : {{ $course->title }}</label>
                                <input type="hidden" name="course_id" class="form-control" value="{{ $course->id }}" readonly>
                            </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('lms.courses.show', $course->id) }}" class="btn btn-secondary float-end">Back</a>
                    </div>
                </div>
            </div>
        </div>
